...
public class MoveMaker {
	...
	private void initMap(){
		...
		map.put(new Candy().getKey() + new Cream().getKey(), new NothingMove(grid));
		...
		map.put(new HorizontalStripedCandy().getKey() + new Cream().getKey(), new NothingMove(grid));
		...
		map.put(new VerticalStripedCandy().getKey() + new Cream().getKey(), new NothingMove(grid));
		...
		map.put(new WrappedCandy().getKey() + new Cream().getKey(), new NothingMove(grid));
		...
		map.put(new Bomb().getKey() + new Cream().getKey(), new NothingMove(grid));
		...
		map.put(new Nothing().getKey() + new Cream().getKey(), new NothingMove(grid));
		
		map.put(new Cream().getKey() + new Candy().getKey(), new NothingMove(grid));
		map.put(new Cream().getKey() + new HorizontalStripedCandy().getKey(), new NothingMove(grid));
		map.put(new Cream().getKey() + new VerticalStripedCandy().getKey(), new NothingMove(grid));
		map.put(new Cream().getKey() + new WrappedCandy().getKey(), new NothingMove(grid));
		map.put(new Cream().getKey() + new Bomb().getKey(), new NothingMove(grid));
		map.put(new Cream().getKey() + new Nothing().getKey(), new NothingMove(grid));
		map.put(new Cream().getKey() + new Cream().getKey(), new NothingMove(grid));
	}
