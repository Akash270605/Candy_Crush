...
public class CandyFrame extends JFrame{
    ...
    private void setImageCell(int i, int j, boolean hint){
        try{
            ...
            Image nothing = ImageIO.read(new File("src/game/resources/images/nothing.png"));
            
            bp.appendImage(i, j, nothing);
            
            if(cell instanceof JellyCell){
                JellyCell jc = (JellyCell) cell;
                Image jelly = ImageIO.read(new File("src/game/resources/images/jelly.png"));
                if(jc.isActive())
            ...
            if(cell instanceof CreamCell){
                ...
                Image cream = ImageIO.read(new File("src/game/resources/images/block.png"));
